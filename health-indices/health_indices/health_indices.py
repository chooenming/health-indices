...
def bodymassindex(mass, height):
    ...
    -----
    >>> from health_indices import bmi
    >>> bodymassindex(mass=65, height=1.70)
    >>>
    -----
    """
    bmi_formula = mass // height**2
...
def bai(hip_circumference, height):
    """
    Body Adipose Index: Measure the amount of body fats in humans

    Params:
    -----
    hip_circumference: int/float: hip circumference of the person in m
    height: int/float: height of the person in m
    -----

    Usage:
    -----
    >>> from health_indices import bai
    >>> bai(hip_circumference=30, height=1.70)
    ------
    """
